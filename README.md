...
패션 커머스 플랫폼에서 커뮤니티 활동(리뷰, 좋아요)이 유저 참여도 및 구매 전환에 미치는 영향을 분석하고,
이탈 징후 유저 대상 리텐션 트리거 시나리오를 제안한다.
...
![세그먼트별 커뮤니티 활동 분석]
<img width="2386" height="744" alt="ltv_distribution" src="https://github.com/user-attachments/assets/b4eb6434-6356-4838-8b0e-755d27413f03" />
---

## 핵심 인사이트

**1. Community Only가 핵심 성장 레버**
